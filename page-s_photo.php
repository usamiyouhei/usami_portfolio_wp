...
<?php if (function_exists('bcn_display')) { ?>
      ...
      <section class="website-service" id="gallery">
        <div class="fv-img__Photographer">
        <!-- <img src="./img/web-site-service-img.jpg" alt="" class="fv-img"> -->
        <h2 class="page-title__photo">Photographer service</h2>
      </div>
      <div class="test-slick js-slick01 fade-in fade-in-up">
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/Hg-img1.jpg")); ?>" alt="" width="500" height="233" />
        </div>
        <div class="test-slick__item">
          <img
        ...
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/Hg-img3.jpg")); ?>" alt="" width="500" height="233" />
        </div>
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/Hg-img7.jpg")); ?>" alt="" width="500" height="233" />
        </div>
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/Hg-img8.jpg")); ?>" alt="" width="500" height="233" />
        </div>
        <div class="test-slick__item">
          <img
            src="<?php echo esc_url(get_theme_file_uri("./img/p-img5.jpg")); ?>"
            alt=""
            width="500"
            height="233"
          />
        ...
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/p-img1.jpg")); ?>" alt="" width="500" height="233" />
        </div>
        <div class="test-slick__item">
          <img src="<?php echo esc_url(get_theme_file_uri("./img/p-img2.jpg")); ?>" alt="" width="500" height="233" />
        </div>
      </div>
